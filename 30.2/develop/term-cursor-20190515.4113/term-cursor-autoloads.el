;;; term-cursor-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
This is a minor mode.  If called interactively, toggle the `Term-Cursor
...
evaluate the variable `term-cursor-mode'.
