;;; livid-mode-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
This is a minor mode.  If called interactively, toggle the `livid mode'
...
evaluate the variable `livid-mode'.
